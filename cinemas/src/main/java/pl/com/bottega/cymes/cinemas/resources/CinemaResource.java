...
public class CinemaResource {
    ...
    public void suspend(@PathVariable("id") Long cinemaId, @RequestBody SuspendRequest suspendRequest) {
    ...
    public SuspensionCheckDto suspensionCheck(@PathVariable("cinemaId") Long cinemaId, @RequestParam("at") Date at) {
