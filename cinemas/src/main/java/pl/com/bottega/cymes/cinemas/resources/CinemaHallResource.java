...
public class CinemaHallResource {
    ...
    @PostMapping
    public void create(@RequestBody CreateCinemaHallRequest createCinemaHallRequest) {
    ...
    public void suspend(@PathVariable("hallId") Long hallId, @RequestBody SuspendRequest suspendRequest) {
    ...
    @PutMapping("/{hallId}")
    public void update(@PathVariable("hallId") Long hallId, @RequestBody UpdateCinemaHallRequest updateCinemaHallRequest) {
    ...
    public SuspensionCheckDto suspensionCheck(@PathVariable("hallId") Long hallId, @RequestParam("at") Date at) {
        return new SuspensionCheckDto(cinemaHallService.isSuspended(hallId, at.toInstant()));
    }
}